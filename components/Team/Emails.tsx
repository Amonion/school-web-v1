  ...
  return (
    <>
      <div className="card_body">
        <div className="custom_sm_title">Table of Emails</div>
                      ...
                      {item.isActive && (
                        <div className="card_list">
                          ...
                          <Link
                            ...
                            href={`/team/messages/emails/create-email?id=${item._id}&name=${item.name}`}
                          >
                            Edit Email
                          </Link>
                          <div
        ...
        <div className="table_action">
          {loading ? (
            ...
            <>
              ...
              <Link
                href="/team/messages/emails/create-email"
