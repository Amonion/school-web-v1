...
import CountryStore from '@/src/zustand/users/CountryOrigin'
import StateStore from '@/src/zustand/users/StateOrigin'
import AreaStore from '@/src/zustand/team/Area'
import { motion } from 'framer-motion'
import { addQuery } from '@/lib/helpers'

export default function OriginPlaceTab() {
  const {
    countries,
    getCountries,
