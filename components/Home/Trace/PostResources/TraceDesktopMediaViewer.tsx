...
import TraceMediaReactions from './TraceMediaReactions'
import FullMediaCommentSection from '../../Comment/FullMediaComment'

interface TraceDesktopMediaViewerProps {
  media: Media
  onClose: () => void
  goToPrevious: () => void
  goToNext: () => void
...
const TraceDesktopMediaViewer: React.FC<TraceDesktopMediaViewerProps> = ({
  media,
  onClose,
  goToPrevious,
  goToNext,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <TraceMediaReactions media={media} isDesktop={true} />
      </div>
      <FullMediaCommentSection isDesktop={true} />
      {/* <MediaCommentSection isDesktop={true} /> */}
    </div>
  )
}

export default TraceDesktopMediaViewer
