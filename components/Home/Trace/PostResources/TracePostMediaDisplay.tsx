...
import TraceDesktopMediaViewer from './TraceDesktopMediaViewer'
import TraceMobileMediaView from './TraceMobileMediaView'
import { PostStore } from '@/src/zustand/Trace/TracePosts'

const TracePostMediaDisplay: React.FC = () => {
  const {
    currentPage,
    page_size,
    isMobile,
...
export default TracePostMediaDisplay
