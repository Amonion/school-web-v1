...
interface TraceMobileMediaViewProps {
  media: Media
  postForm: Post
  onClose: () => void
...
const TraceMobileMediaView: React.FC<TraceMobileMediaViewProps> = ({
  media,
  postForm,
  onClose,
  onTouchStart,
      ...
      <div className="flex z-40 bg-black fixed left-0 top-0 w-full h-[100vh]">
        ...
        >
          ...
          >
            ...
            {!showGlassComments && <TraceMediaReactions media={media} />}
          </div>
        </motion.div>
      </div>
...
export default TraceMobileMediaView
