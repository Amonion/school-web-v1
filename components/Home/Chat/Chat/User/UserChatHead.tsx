...
export default function ChatHead() {
  ...
  const { formData, getItem } = UserInfoStore();
  const {
    loading,
    searchChats,
    searchResult,
  ...
  useEffect(() => {
    if (username) {
      getItem(`/users/details/${username}`, setMessage);
    }
  }, []);
  ...
  return (
    <>
      <div className="flex-1 relative flex items-center sm:px-[10px]">
          ...
          <>
            {formData.username ? (
              <div className="flex items-center cursor-default ">
                {
                  <Link
                    href={`/home/user/${formData.username}`}
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center">
                    ...
                    {pathname.includes("favourites") ? (
                      ...
                      <Link
                        href={`/home/chat/user/${username}/favourites`}
                        className="round secondary"
                      >
              ...
              <div className="flex-1 text-center">USER NOT FOUND</div>
            )}
          </>
        </div>
