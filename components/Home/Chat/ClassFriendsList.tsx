...
import ClassFriendStore from '../../../src/zustand/chat/ClassFriend'
import { RelativeTime } from './RelativeTime'

const ClassFriendsList: React.FC = () => {
  const { friendsResults } = ClassFriendStore()
      ...
      <div className="flex-1 overflow-y-auto chat_scrollbar pr-2">
        ...
        {friendsResults.length === 0 && (
          <div className="w-full pb-5 flex flex-col">
            <div className="text-center mb-5">You have no class mates yet.</div>
            <Image
              style={{
                maxHeight: '70vh',
                height: 'auto',
            ...
            <div className="flex justify-center text-center">
              Your class mates will be automatically added once they are
              verified.
            </div>
          </div>
        )}
...
export default ClassFriendsList
