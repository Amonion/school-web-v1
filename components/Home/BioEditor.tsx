...
const extensions = [
  ...
  Placeholder.configure({
    placeholder: "Write an intro about yourself …",
  }),
  Image,
  AlignableImage,
  Dropcursor,
...
const BioEditor: React.FC<MyEditorProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="bio mb-5 w-full bg-[var(--secondary)] rounded-[10px]">
