  ...
  const handleSubmit = () => {
    if (
      ...
      const form = {
        ...
        level: schoolData.levels[selectedLevel].level,
        levelName: schoolData.levels[selectedLevel].levelName,
            ...
            <div className="flex-1 overflow-auto">
              <div className="flex flex-col items-center">
                ...
                <div className="text-center text-sm mb-10">
                  To apply to {schoolData.name}, below are the required bio data
                  you will transfer.
                </div>
              </div>
              ...
              <div className="px-2  mb-5">
                ...
                <div className="flex flex-col items-center h-full">
                  ...
                  >
                    {birthCert && <PictureDisplay source={String(birthCert)} />}
                  </div>
                </div>
              </div>
              <div className="px-2  mb-5">
                          ...
                          {Array.from(
                            ...
                            (_, index) => (
                              ...
                              >
                                <div
                                  onClick={() =>
                                    selectClass(int, index, level.levelName)
                                  }
                                  className={`${
                                    selectedLevel === int &&
