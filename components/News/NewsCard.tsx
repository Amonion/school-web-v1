  ...
  return (
    <>
      <div ref={lastRef} className="">
        <div className="w-full lg:h-[200px] h-[250px] relative xs:h-[300px] sm:h-[250px] md:h-[250px] overflow-hidden">
          {post.picture && (
            <Image
        ...
        <div className="py-3 text-[var(--text-secondary)]">
          <div className="line-clamp-2 overflow-ellipsis">{post.title}</div>
        </div>
      </div>
    </>
  )
