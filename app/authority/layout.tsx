...
import SchoolMainHeader from '@/components/Authority/Navigation/SchoolMainHeader'
import AuthorityNavigation from '@/components/Authority/Navigation/AuthorityNavigation'
...
export default function SchoolLayout({
  ...
  useEffect(() => {
    if (bioUserState && bioUserState.activeOffice) {
      getOffice(
        `/offices/${bioUserState.activeOffice.position.replace(
          ' ',
          '_'
