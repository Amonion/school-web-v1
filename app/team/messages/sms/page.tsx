  ...
  return (
    <>
      <div className="card_body">
        <div className="custom_sm_title">Table of SMS</div>
        <div className="overflow-auto mb-5">
          {results.length > 0 ? (
                      ...
                      {item.isActive && (
                        <div className="card_list">
                          ...
                          <Link
                            ...
                            href={`/team/messages/sms/create-sms?id=${item._id}&name=${item.name}`}
                          >
                            Edit Sms
                          </Link>
                          <div
            ...
            <div className="relative flex justify-center">
              <div className="not_found_text">No SMS Found</div>
              <Image
        ...
        <div className="table-action flex mb-4">
          {loading ? (
            ...
            <>
              ...
              <Link
                href="/team/messages/sms/create-sms"
