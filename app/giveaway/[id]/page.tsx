...
const Home: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="px-2 sm:px-0 sm:pr-2 md:pr-0 pb-2">
        <div className="mb-2">
          <div className="text-lg text-[var(--text-secondary)] sm:text-xl mb-1">
            {newsForm.title}
          </div>
        ...
        <div className="mb-5 flex items-center">
          ...
          <div className="flex pl-3 items-center flex-wrap">
            <div className="mr-3 h-2 w-2 rounded-full bg-[var(--text-primary)]" />
