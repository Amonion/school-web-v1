...
export default function UtilsDashboard() {
  ...
  useEffect(() => {
    ...
    getActivities(
      `${url}/?schoolUsername=${officeForm.username}&page_size=${page_size}&page=1&ordering=-createdAt`,
      setMessage
    )
  }, [officeForm])
              ...
              <div className="flex items-center">
                ...
                {officeForm.username === 'Minister' && (
                  <div
                    ...
                    className="ml-auto cursor-pointer text-sm text-[var(--custom)]"
                  >
                    Edit
                  </div>
                )}
