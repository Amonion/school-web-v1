...
import ChatBody from '@/components/Users/Chat/ChatBody'
...
import { ChatContent, FileType } from '@/src/interface/user/interface'
import { Smile } from 'lucide-react'
import ChatEditor from '@/components/Users/Chat/ChatEditor'
import { GlobalWorkerOptions, getDocument } from 'pdfjs-dist'
import { User } from '@/src/interface/team/interface'
import FriendStore from '@/src/zustand/users/Friend'
...
const UserChat = () => {
  ...
  const { formData, loading } = UserStore()
  ...
  const postMessage = () => {
    ...
    if (socket) {
      const form = {
        ...
        userId: user?._id,
        receiverUsername: formData.username,
        receiverPicture: formData.picture,
        receiverId: _id,
